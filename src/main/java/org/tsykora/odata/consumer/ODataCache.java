...
/**
 * ODataCache implements BasicCache API. This provide access to Service endpoint and caches running on side of
 * Producer.
 *
 * @author tsykora
 */
public class ODataCache<K, V> implements BasicCache<K, V> {
   ...
   public V get(Object key) {
      ...
      try {
         ...
         System.out.println("OdataCache PUT - IOEXCEPTION: " + ioe.getMessage());
      } catch (ClassNotFoundException cnfe) {
         System.out.println("OdataCache PUT - CLASSNOTFOUNDEXCEPTION: " + cnfe.getMessage());
      }
      return v;
