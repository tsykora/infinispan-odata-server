 ...
 * @author tsykora
 */
public class InMemoryProducerExample2 extends AbstractExample {

    public static void main(String[] args) {
        InMemoryProducerExample2 example = new InMemoryProducerExample2();
        example.run(args);
    }
    ...
    public void run(String[] args) {
        ...
        String endpointUri2 = "http://localhost:9887/ODataInfinispanEndpoint.svc/";
       ...
       cacheNames.put("mySpecialNamedCache2", MyInternalCacheEntrySimple.class);
        ...
        final InfinispanProducer2 producerBig2 =
              new InfinispanProducer2("InMemoryProducerExample2", null, 100, new MyEdmDecorator(), null, cacheNames, "infinispan-dist2.xml");
...
//        reportEntity("\n\n\n This is response from producer (InMemoryProducerExample), recently created OEntity: \n ", createdRightNow);
       ...
       // START second ODATA SERVER (make caches distributed, put and verify on other server, it was putted)
       DefaultODataProducerProvider.setInstance(producerBig2);
       this.rtFacde.hostODataServer(endpointUri2);
    }
   ...
   public static class MyInternalCacheEntrySimple {
    ...
    public static class MyEdmDecorator implements EdmDecorator {
        ...
        public EdmDocumentation getDocumentationForSchema(String namespace) {
            return new EdmDocumentation("InMemoryProducerExample2", "This schema exposes cache entries stored in Infinispan cache.");
        }
        ...
        public List<EdmAnnotation<?>> getAnnotationsForSchema(String namespace) {
            ...
            p.add(OProperties.string("SeeAlso", "InMemoryProducerExample2.java"));
