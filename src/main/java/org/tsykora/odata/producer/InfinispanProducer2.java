...
//               // TODO - register entrySet for new cache after it starts.
    ...
    public EntityResponse getEntity(ODataContext context, final String entitySetName, final OEntityKey entityKey, final EntityQueryInfo queryInfo) {
        ...
        if (cacheNames.get(entitySetName) == MyInternalCacheEntry.class) {
            ...
            // I have byte[] here, need to deserialize
            ispnCacheKey = deserialize((byte[]) entityKey.asSingleValue());
        } else {
            // isSimple!
            ...
            ispnCacheKey = entityKey.asSingleValue();
        }
    ...
    public EntityResponse createEntity(ODataContext context, String entitySetName, final OEntity entity) {
        ...
        if (entity.getEntityKey() == null) {
            ...
            if (!simpleStringStringHandling) {
                ...
                // if I deserialize here, I got: CacheObjectSerializationAble object
                ...
                // class of this value for key "Key" has to be EDM.SIMPLE_TYPE
                // now I am returning byte[] (TODO: consider encode to String Base64)
                entityKeysValues.put("Key", key);
            } else {
            ...
            try {
                ...
                dump("\n\n\nThere is hidden IllegalArgumentException here!!!! Now I can catch it, but it's tricky!!! \n " +
                       iae.getMessage() + "\n\n");
            }
        }
